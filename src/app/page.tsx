        ...
        <div className="container mx-auto px-6">
          ...
          <div className="text-center mt-16">
            <a
              ...
              className="inline-flex items-center gap-3 bg-cyan-500/10 border border-cyan-500/30 hover:border-cyan-500/60 text-cyan-400 hover:text-cyan-300 px-8 py-4 rounded-lg font-bold tracking-widest uppercase transition-all hover:shadow-[0_0_30px_rgba(0,195,255,0.2)] cursor-pointer"
            >
