      ...
      <div className="container mx-auto px-6 py-4">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center gap-3">
            <Link 
              href="/admin/login"
              className="text-sm tracking-widest uppercase text-gray-400 hover:text-amber-500 transition font-medium flex items-center gap-2 px-3 py-2 rounded-lg hover:bg-white/5"
            >
